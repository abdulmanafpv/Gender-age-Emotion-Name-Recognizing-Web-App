...
from age_detection import Age_Model
from gen_detection import Gender_Model
from race_detection import Race_Model
from emo_detection import predict_emotions
    ...
    for data_face in out:
        ...
        if len(box) == 0:
            ...
            try:
                ...
                pass
            try:
                cv2.putText(img, "name: " +data_face["name"], (x0, y0-step-10*7), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0,255,0), thickness)
            except:
                pass
    return img